...
{Разработка и поддержка облачной ERP-системы (SaaS) для малого и среднего бизнеса.
\begin{itemize}[label=\textbullet]
...
\end{itemize}
Основные используемые технологии: C\#, SQL, .NET, ASP.NET MVC, ASP.NET WebAPI, SQL Server, MySQL, Amazon AWS, Git, Atlassian stack}
